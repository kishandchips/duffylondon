...
<?php
	if ( $order->billing_email ) echo '<span><dt>' . __( 'Email:', 'woocommerce' ) . '</dt><dd>' . $order->billing_email . '</dd></span>';
	if ( $order->billing_phone ) echo '<span><dt>' . __( 'Telephone:', 'woocommerce' ) . '</dt><dd>' . $order->billing_phone . '</dd></span>';
