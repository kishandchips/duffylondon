...
<form class="shipping_calculator" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">
	...
	<header class="line-header">
		<h2 class="title"><a href="#" class="shipping-calculator-button"><?php _e( 'Calculate Shipping', 'woocommerce' ); ?></a></h2>
	</header>
	...
	<section class="shipping-calculator-form">
		...
		<p class="inline-block"><button type="submit" name="calc_shipping" value="1" class="button"><?php _e( 'Update Shipping', 'woocommerce' ); ?></button></p>
